...
//This is an example of closure. The nestedFunction can reach outside of it's scope to the outer scope and use the variables there for its internal use. 
  ...
  */
  ...
  function animalNames(arr){
    ...
    arr.forEach(function(item){
      let string = `name: ${item.animal_name}, scientific: ${item.scientific_name}`
